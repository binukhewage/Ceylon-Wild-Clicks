              ...
              >
                ...
                <div className="p-6">
                  ...
                  <Link href={`/prints/${print.id}`}>
                   <div className="bg-earth-green text-center p-2">BUY</div> 
                  </Link>
                </div>
              </motion.div>
            ))}
                ...
                <div className="p-8">
                  ...
                  <div className="space-y-4 mb-6">
                    <div className="flex justify-between border-b border-gray-800 pb-2">
                      ...
                      <span className="font-lora text-earth-green text-xl">
                        ${selectedPrint.price}
                      </span>
                    </div>
                    <div className="flex justify-between border-b border-gray-800 pb-2">
                    ...
                    <div className="flex justify-between border-b border-gray-800 pb-2">
                      ...
                      <span className="font-lora text-white capitalize">
